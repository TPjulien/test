    ...
    router.route('/downloadPDF/:id_item')
      ...
      .get (function (req, res) {
            var query = "SELECT ??, ??, ??, ??, ??, ??, ??, SUM(??) AS TOTAL_AMOUNT, ?? FROM ?? ";
  	        var table   = ["SUPPLIER", "TYPE", "HEADER_ACCOUNT_NUMBER", "LINE_DESCRIPTION", "TRAVELLER", "HEADER_FAC_TYPE", "HEADER_DEPARTURE_DATE", "AMOUNT", "NUM_INVOICE", "accelya.accelya_view_all"];

...
SAML.prototype.generateLogoutRequest = function (req) {
  ...
  if (typeof(req.user.nameQualifier) !== 'undefined') {
    request['samlp:LogoutRequest']['saml2:NameID']['@NameQualifier'] = req.user.nameQualifier;
  }

  if (typeof(req.user.spNameQualifier) !== 'undefined') {
    request['samlp:LogoutRequest']['saml2:NameID']['@SPNameQualifier'] = req.user.spNameQualifier;
  }
    
  // debug 
  request['samlp:LogoutRequest']['saml2:NameID']['@xmlns:saml2'] = "urn:oasis:names:tc:SAML:2.0:assertion";
